...
import { getPageBySlug, getGlobalSettings } from "@/lib/sanity";
import { PageBuilder } from "@/components/blocks";

export default async function HomePage() {
  // Try to fetch page from Sanity
  const page = await getPageBySlug("home");
  const settings = await getGlobalSettings();

  // If Sanity content exists, use PageBuilder
  if (page && page.pageBuilder && page.pageBuilder.length > 0) {
    return (
          ...
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-xl text-gray-700 mb-8 leading-relaxed">
                Have insurance authorizations, patient scheduling, & clinical notes handled. Reduce
                the admin chaos to focus on patient care.
              </p>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600">
                Practices lose hours every day to scheduling chaos, insurance work & clinical notes.
                We take those tasks off your plate with dedicated, full-time support.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="border-0 shadow-md hover:shadow-xl transition-shadow bg-white">
                ...
                <CardContent>
                  <p className="text-gray-600 mb-6 text-lg">
                    We handle all your incoming calls, patient reminders, and scheduling. Keep your
                    front desk organized and your schedule full.
                  </p>
                  <a
                    href="/services"
              ...
              <Card className="border-0 shadow-md hover:shadow-xl transition-shadow bg-white">
                ...
                <CardContent>
                  <p className="text-gray-600 mb-6 text-lg">
                    Prior auths, benefits verification & eligibility checks completed before the
                    patient arrives. No more surprise denials.
                  </p>
                  <a
                    href="/services"
                    className="text-primary-600 hover:text-primary-700 font-semibold inline-flex items-center"
              ...
              <Card className="border-0 shadow-md hover:shadow-xl transition-shadow bg-white">
                ...
                <CardContent>
                  <p className="text-gray-600 mb-6 text-lg">
                    Leave by 5pm. Have your EHR charting, prescription refills & patient follow-ups
                    handled with dedicated medical assistance.
                  </p>
                  <a
                    href="/services"
                    className="text-primary-600 hover:text-primary-700 font-semibold inline-flex items-center"
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-4xl mx-auto">
                Save 20+ hours a week and improve your practice's workflow. No more call delays,
                late authorizations & disorganized clinical work.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <Card className="border-0 shadow-md bg-red-50">
                <CardHeader className="bg-red-100 rounded-t-lg">
                  <CardTitle className="text-3xl text-center text-red-700">
                    Before NexClinical
                  </CardTitle>
                </CardHeader>
              ...
              {[
                {
                  ...
                  quote:
                    "Our phones were ringing nonstop, and patients were getting voicemail or waiting on hold. We were constantly double-booking or missing appointments. NexClinical took over scheduling, cleaned up the calendar, and made sure calls were actually answered. It immediately reduced the daily stress in the office.",
                  author: "Dr. Rebecca S",
                ...
                },
                {
                  ...
                  quote:
                    "We didn't realize how many appointments we were losing just because calls weren't being picked up. NexClinical stepped in, handled scheduling consistently, and followed up with patients. Our schedule is fuller now, and things don't fall through the cracks anymore.",
                  author: "Thomas M",
                ...
                },
                {
                  ...
                  quote:
                    "Our front desk was juggling patients at the counter, phones, and insurance checks all at once. Scheduling always fell behind. NexClinical took that responsibility off our team, and everything runs smoother. Patients get booked faster and the staff isn't overwhelmed.",
                  author: "Sarah L",
                ...
                },
                {
                  ...
                  quote:
                    "Prior authorizations were slowing everything down. We had approvals sitting for days because no one had time to follow up. NexClinical took over the process, tracked each request, and stayed on the insurance companies. Approvals are coming through faster and patients aren't stuck waiting.",
                  author: "Dr. Ahmed",
                ...
                },
                {
                  ...
                  quote:
                    "Insurance work used to pile up quickly. We'd submit authorizations but didn't always have time to chase them. NexClinical brought structure to the whole process. Now we know what's pending, what's approved, and nothing gets lost.",
                  author: "Jennifer R",
                ...
                },
                {
                  ...
                  quote:
                    "Authorization delays were creating a backlog that affected patient care and scheduling. NexClinical stepped in and handled the insurance side consistently. It's taken a huge burden off our internal team and helped us move patients through faster.",
                  author: "Dr. Michael H",
                ...
                },
                {
                  ...
                  quote:
                    "Having clinical notes handled during or right after visits completely changed my workflow. Documentation is accurate, timely, and aligned with my EHR. I finally leave the office on time without worrying about unfinished charts.",
                  author: "Kate Winslet",
                ...
                },
                {
                  title: "Primary Care Practice / Specialty Clinic",
                  quote:
                    "The e-scribe support integrates smoothly with our EHR and follows our templates and clinical style. Notes are clean, detailed, and compliant, which has helped reduce back-and-forth corrections and coding issues.",
                  author: "Jack",
                ...
                },
                {
                  title: "Primary Care Practice / Specialty Clinic",
                  quote:
                    "Having dedicated clinical note support has been a game changer as we've grown. Providers stay engaged during visits, charts are completed faster, and overall efficiency across the practice has improved without adding in-house staff.",
                  author: "Wesley",
            ...
            <div className="grid md:grid-cols-4 gap-8">
              {[
                ...
                <div key={idx} className="text-center">
                  ...
                  <div className="mb-4">
                    <div className="flex justify-center text-primary-600 mb-3">{step.icon}</div>
